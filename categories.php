...
?>
 ...
 <div class="container px-5">
     ...
     <div class="row " id="featured-product">
        <?php  $catData = get_product($conn,'',$cat_id);
             foreach ($catData as   $value) { ?>

                <div class="col-lg-3 col-sm-3 col-6">
                <a href=" "><img src="adminPanel/<?php echo $value['img']; ?>" class="img-fluid" style="height:310px; width:240px;"></a>
                <p class="text-capitalize font-weight-bold text-center my-2"></p>
                <div class="rating text-center">
                   <p><?php echo $value['name']; ?></p>
                    <p class="font-weight-bold"> <span class="text-muted text-center"> ₹</span> &nbsp; ₹ </p>
                </div>
            </div>
          <?php   } ?>
         </div>
