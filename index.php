                ...
                <div class="form-group px-5 py-5 ">
                    ...
                    <div class="row  ">
                        <div class="col-lg-12 col-12">
                            <input type="text" name="newname" class="form-control" id="" placeholder="Enter Your Name">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <input type="text" class="form-control" id="" name="phone" aria-describedby="emailHelp" placeholder="Contact Number">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 my-3">
                            <input type="datetime-local" class="form-control " name="date" id=" " placeholder="Select Date">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 1) {
                    ...
                    $('#verifyMsgEmail').fadeIn(1000)
                    setTimeout(function() {
                       
                        $('#verifyMsgEmail').fadeOut(1000)
                    }, 2000);
                }
            }
        })
