                        ...
                        <form class="mx-3 w-50" method = "post">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" class="form-control" name = "newCat"
                                   aria-describedby="emailHelp"  placeholder=" Enter Category" id="Updatecategory" required value="<?php echo $catname; ?> ">
                                
                           </div>
                           
                           <h6 class ="text-danger text-capitalize font-weight-bold"> </h6>
                           <button type="button" name =" " id="add" class="btn text-uppercase font-weight-bold btn-primary " style=" letter-spacing: 5px; ">Update Category</button>
