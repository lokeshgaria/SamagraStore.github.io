             ...
             <div class="col-xl-10 col-lg-9  col-md-8 ml-md-auto">
                 <div class="row">
                     <div class="col-12">
                         ...
                         <table class="table table-fluid bg-light text-center  table-striped" id="product_table">
                             <thead>
                                 <tr class="text-muted">
                                    ...
                                    ?>
                                     <tr class="font-weight-bold">
                                         ...
                                         <td class="d-flex justify-content-center"><?php
                                                                                    ...
                                                                                    echo "<a href='?delete_id=" . $data['id'] . "' class='nav-link text-white mx-2 btn-danger '><i class='fas fa-trash-alt'></i></a>";
     ...
     <div class="container-fluid " id="orderTable">
         <div class="row mb-5 ">
             <div class="col-xl-10 col-lg-9  col-md-8 ml-md-auto">
                 <div class="row">
                     <div class="col-12">
                         <h3 class="text-muted text-start font-weight-bold my-3 mb-3">  Order Master </h3>
                                 ...
                                 <?php
                                    ...
                                    ?>
                                     <tr class="font-weight-bold" >
                                         ...
                                         <td>  <a href="orderdetail.php?id=<?php echo $data['id']; ?>" class="nav-link text-dark" ><?php echo  $i; ?> </a> </td>

                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"   class="nav-link text-dark" > <?php echo $data['username'] ?></a> </td>

                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"   class="nav-link text-dark" > <?php echo $data['id'] ?></a> </td>
                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"  class="nav-link text-dark" > <?php echo $data['added_on'] ?> </a></td>
                                         
                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"  class="nav-link text-dark" > <?php echo $data['adddress'] ?> </a></td>
                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"  class="nav-link text-dark" > <?php echo $data['payment_type'] ?></a> </td>
                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"  class="nav-link text-dark" ><?php echo $data['payment_status'] ?> </a> </td>

                                         <td> <a href="orderdetail.php?id=<?php echo $data['id']; ?>"  class="nav-link text-dark" ><?php echo $data['order_status'] ?> </a> </td>
