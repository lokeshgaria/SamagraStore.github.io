                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                aria-describedby="emailHelp"  id="productName" placeholder="  Enter Product Name" required
                                                value=" ">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mrp"
                                                aria-describedby="emailHelp" id="mrp" placeholder="  Enter MRP" required
                                                value=" ">
                                        </div>
                                    </div>
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="price"
                                                    aria-describedby="emailHelp" id="price" placeholder="  Enter Price"
                                                    value=" ">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="qty"
                                                aria-describedby="emailHelp" id="qty" placeholder="  Enter Quantity" required
                                                value=" ">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="shortDesc" name="short_desc"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="metaDesc" name="meta_desc"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="metaKeyword" name="meta_keyword"
                                                placeholder="Enter  Meta keyword Description" placeholder="Meta Title"
                                                value=""> </textarea>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <h6>  Add product </h6>
                                        <button  name="submit" id="addproduct"
                                            class="btn text-uppercase font-weight-bold btn-primary  w-100"
                                            style=" letter-spacing: 5px; padding:15px 0;"> Add product</button>
